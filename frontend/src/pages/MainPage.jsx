    ...
    <div className="w-full min-h-screen flex flex-col bg-gray-100">
      ...
      <nav className="w-full flex justify-between items-center px-6 py-4 md:px-10">
        <div className="text-2xl font-bold flex items-center">
          <img src="/logo.png" alt="Budgetr Logo" className="h-10 md:h-12" /> {/* Replace with your logo */}
        </div>
      ...
      {/* Hero Section */}
      <section className="flex flex-col md:flex-row items-center justify-between w-11/12 md:w-9/12 mx-auto flex-grow">
        {/* Left: Image */}
